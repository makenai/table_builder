...
I forked https://github.com/jchunky/table_builder to make it Rails 3 friendly.

= TableBuilder

Rails builder for creating tables and calendars inspired by ActionView's FormBuilder, updated for Rails 3.0
...
Thanks to Petrik de Heus, Sean Dague, and Jason Cheong-Kee-You
...
Fork revisions Copyright (c) 2011 Sasha Parfenov, released under the MIT license.
